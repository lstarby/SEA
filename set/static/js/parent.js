...
function callBack(data){
    ...
    pieChart(dataPieOne, pieTitle, '#pieChart1');
    pieChart(dataPieSec, pieTitle, '#pieChart2');

    var searchItems = getSearchItem(),
        navId = searchItems.navId;
    renderNews(dataNews, navId);
}

function renderNews(data, navId){
    //console.log(data);
    ...
    for(var i = 1, length = data.length; i <length; i ++){
        var news = new SonNews(data[i], navId);
