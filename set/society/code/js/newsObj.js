...
var BannerNews = function (result, nav) {
    ...
    if(!this.picSrc){
        this.picSrc ='../images/banner/3.jpg';
    }
};
var News = function (result, nav) {
    ...
    if(!this.parPic){
        this.parPic = '../images/banner/1.jpg';
    }
    ...
    if(!this.sonPicOne){
        this.sonPicOne = '../images/banner/1.jpg';
    }
    if(result.length == 3){
        var son2 = result[2];
        ...
        if(!this.sonPicSec){
            this.sonPicSec = '../images/banner/1.jpg';
        }
    }
